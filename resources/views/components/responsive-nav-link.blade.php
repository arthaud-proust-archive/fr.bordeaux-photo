...
$classes = ($active ?? false)
            ? 'block px-6 py-3 text-base font-medium text-p1 bg-s3 focus:outline-none focus:text-indigo-800 focus:bg-indigo-100 focus:border-indigo-700 transition duration-150 ease-in-out'
