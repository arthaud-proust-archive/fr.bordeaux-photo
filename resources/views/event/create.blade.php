<x-app-layout>
    ...
    <x-view.section width="3">
        <x-form.base :action="route('event.store')" method="POST" submitColor="green" submitText="Ajouter" cancel>
            ...
            <x-form.field type="select" label="Organisé avec" name="team" :options="$teams"/>
            <x-form.field type="checkbox" label="Tout le monde peut participer" name="public" value="true" desc="Si non, seul les membres de 'Organisé avec' pourront participer"/>
