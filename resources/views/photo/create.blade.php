...
<x-app-layout>
    ...
    <x-view.section width="3">
        <x-form.base :action="route('photo.store')" method="POST" cancel submitColor="green" enctype="multipart/form-data">
            ...
            <x-form.field type="input" label="Titre (optionnel)" name="title" placeholder="Il pourrait éclairer votre photo" desc="Maximum 20 caractères, la photo doit être compréhensible sans le titre"/>
